        ...
        <div className={style.container_onboarding}>
            ...
            className={style.container_centercontent}>
                <div className={style.container_posters}>
                    ...
                    <motion.div
                        animate={{opacity: [0,1,0], scale: [0.9, 1, 0.9], translateX: ["-50%", "20%", "-50%"] }}
                        transition={{
                            duration: 1,
                            times: [0, 1, 2],
                            ease: [0.85, 0, 0.15, 1],
                    ...
                    <motion.div
                        animate={{opacity: [1,0,1], scale: [1, 0.9, 1], translateX: ["-120%", "-50%", "-120%"] }}
                        transition={{
                            duration: 1,
                            times: [0, 1, 2],
                            ease: [0.85, 0, 0.15, 1],
                    ...
                    <div className={`${style.onboarding_card} ${style.onboarding_card_2}`}></div>
                    <div className={`${style.onboarding_card} ${style.onboarding_card_3}`}></div>
                </div>
                <div className={`${style.container_text} ${"heavy"} `}><p>MovieSync helps you and your friends find new movies to watch together...finally.</p></div>
                {/* <div className={`${style.container_text} ${"heavy"} `}><p>Swipe right to like, or left to dislike. When you and your friends match movies, we’ll let you know!</p></div> */}
            </motion.div>
            <motion.div 
            animate={{ opacity: 1 }}
            initial={{ opacity: 0 }}
            transition={{
              duration: 0.75,
                ...
                <div className={`${sharedStyle.btn} ${style.onboarding_btn} `}>
                    Got It!
                </div>
                <div className={style.onboarding_hyperlink}>Register / Sign In</div>
            </motion.div>
        </div>
        </>
  );
