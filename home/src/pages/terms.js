...
export default function terms() {
  return (
    <>
      ...
      <p>
        Nick Wang built the movie-sync app as a Free app. This SERVICE is
        provided by Nick Wang at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at movie-sync unless otherwise
      ...
      <p>This policy is effective as of 2020-11-21</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at wang703003515@gmail.com.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Nick
        Wang.
      </p>{" "}
      <p>
        Nick Wang is committed to ensuring that the app is as useful and
      ...
      <p>
        The movie-sync app stores and processes personal data that you have
        ...
        features and it could mean that the movie-sync app won’t work properly
        or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Nick Wang will
        ...
        Wi-Fi, or provided by your mobile network provider, but Nick Wang cannot
      ...
      <p>
        Along the same lines, Nick Wang cannot always take responsibility for
        ...
        avail the Service, Nick Wang cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Nick Wang’s responsibility for your use of the app, when
        ...
        it available to you. Nick Wang accepts no liability for any loss, direct
      ...
      <p>
        ...
        to keep using the app. Nick Wang does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2020-11-21</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at wang703003515@gmail.com.
      </p>{" "}
      <p>
